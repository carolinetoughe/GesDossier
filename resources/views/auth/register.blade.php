...
<div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="numerotelephone" class="col-md-4 col-form-label text-md-right">{{ __('numero telephone') }}</label>

                            <div class="col-md-6">
                                <input id="numerotelephone" type="text" class="form-control @error('numerotelephone') is-invalid @enderror" name="numerotelephone" value="{{ old('numerotelephone') }}" required autocomplete="numerotelephone" autofocus>
  ...
  <label for="adresse" class="col-md-4 col-form-label text-md-right">{{ __('Image') }}</label>
  <div class="col-md-6">
